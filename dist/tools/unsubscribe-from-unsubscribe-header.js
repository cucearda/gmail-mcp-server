...
const MSG_ERROR_IN_HANDLE_HTTP = (error) => `Error in handleHttpUnsubscribeWithPuppeteer: ${error}`;
 ...
 */
async function handleHttpUnsubscribeWithPuppeteer(url, debug, timeout, steps) {
    let browser = null;
    try {
        // Launch browser
        steps.push({
